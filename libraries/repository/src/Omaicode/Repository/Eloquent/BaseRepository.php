...
namespace Omaicode\Repository\Eloquent;
...
use Omaicode\Repository\Contracts\CriteriaInterface;
use Omaicode\Repository\Contracts\Presentable;
use Omaicode\Repository\Contracts\PresenterInterface;
use Omaicode\Repository\Contracts\RepositoryCriteriaInterface;
use Omaicode\Repository\Contracts\RepositoryInterface;
use Omaicode\Repository\Events\RepositoryEntityCreated;
use Omaicode\Repository\Events\RepositoryEntityCreating;
use Omaicode\Repository\Events\RepositoryEntityDeleted;
use Omaicode\Repository\Events\RepositoryEntityDeleting;
use Omaicode\Repository\Events\RepositoryEntityUpdated;
use Omaicode\Repository\Events\RepositoryEntityUpdating;
use Omaicode\Repository\Exceptions\RepositoryException;
use Omaicode\Repository\Traits\ComparesVersionsTrait;
use Omaicode\Validator\Contracts\ValidatorInterface;
use Omaicode\Validator\Exceptions\ValidatorException;

/**
 * Class BaseRepository
 *
 * @package Omaicode\Repository\Eloquent
...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    /**
     * Specify Validator class name of Omaicode\Validator\Contracts\ValidatorInterface
     *
     * @return null
     * @throws Exception
     */
    public function validator()
    {
        if (isset($this->rules) && !is_null($this->rules) && is_array($this->rules) && !empty($this->rules)) {
            if (class_exists('Omaicode\Validator\LaravelValidator')) {
                $validator = app('Omaicode\Validator\LaravelValidator');
    ...
    public function makePresenter($presenter = null)
    {
        ...
        if (!is_null($presenter)) {
            ...
            if (!$this->presenter instanceof PresenterInterface) {
                throw new RepositoryException("Class {$presenter} must be an instance of Omaicode\\Repository\\Contracts\\PresenterInterface");
            }
    ...
    public function makeValidator($validator = null)
    {
        ...
        if (!is_null($validator)) {
            ...
            if (!$this->validator instanceof ValidatorInterface) {
                throw new RepositoryException("Class {$validator} must be an instance of Omaicode\\Validator\\Contracts\\ValidatorInterface");
            }
     ...
     *
     * @return $this
     * @throws \Omaicode\Repository\Exceptions\RepositoryException
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . get_class($criteria) . " must be an instance of Omaicode\\Repository\\Contracts\\CriteriaInterface");
        }
