...
use Omaicode\Repository\Generators\MigrationGenerator;
use Omaicode\Repository\Generators\ModelGenerator;
use Omaicode\Repository\Generators\RepositoryEloquentGenerator;
use Omaicode\Repository\Generators\RepositoryInterfaceGenerator;
...
class RepositoryCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'ocms:repo:repository';
