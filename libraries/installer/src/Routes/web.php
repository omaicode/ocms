...
Route::group(['namespace' => 'Omaicode\LaravelInstaller\Controllers','middleware' => ['web', 'install']], function() {
Route::get('error/{var}', [
    'uses' => 'WelcomeController@error'
 ]);
});

Route::group(['prefix' => 'install','as' => 'LaravelInstaller::','namespace' => 'Omaicode\LaravelInstaller\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'Omaicode\LaravelInstaller\Controllers','middleware' => 'web'],function() {
