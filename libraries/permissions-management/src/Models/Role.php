...
namespace Omaicode\Permission\Models;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Omaicode\Permission\Contracts\Role as RoleContract;
use Omaicode\Permission\Exceptions\GuardDoesNotMatch;
use Omaicode\Permission\Exceptions\RoleAlreadyExists;
use Omaicode\Permission\Exceptions\RoleDoesNotExist;
use Omaicode\Permission\Guard;
use Omaicode\Permission\PermissionRegistrar;
use Omaicode\Permission\Traits\HasPermissions;
use Omaicode\Permission\Traits\RefreshesPermissionCache;
...
class Role extends Model implements RoleContract
{
     ...
     *
     * @return \Omaicode\Permission\Contracts\Role|\Omaicode\Permission\Models\Role
     *
     * @throws \Omaicode\Permission\Exceptions\RoleDoesNotExist
     */
