...
if (! function_exists('setPermissionsTeamId')) {
    ...
    {
        app(\Omaicode\Permission\PermissionRegistrar::class)->setPermissionsTeamId($id);
    }
}
...
if (! function_exists('getPermissionsTeamId')) {
    ...
    {
        return app(\Omaicode\Permission\PermissionRegistrar::class)->getPermissionsTeamId();
    }
}
