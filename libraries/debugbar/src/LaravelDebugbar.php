...
namespace Omaicode\Debugbar;

use Omaicode\Debugbar\DataCollector\AuthCollector;
use Omaicode\Debugbar\DataCollector\CacheCollector;
use Omaicode\Debugbar\DataCollector\EventCollector;
use Omaicode\Debugbar\DataCollector\FilesCollector;
use Omaicode\Debugbar\DataCollector\GateCollector;
use Omaicode\Debugbar\DataCollector\LaravelCollector;
use Omaicode\Debugbar\DataCollector\LogsCollector;
use Omaicode\Debugbar\DataCollector\ModelsCollector;
use Omaicode\Debugbar\DataCollector\MultiAuthCollector;
use Omaicode\Debugbar\DataCollector\QueryCollector;
use Omaicode\Debugbar\DataCollector\SessionCollector;
use Omaicode\Debugbar\DataCollector\RequestCollector;
use Omaicode\Debugbar\DataCollector\ViewCollector;
use Omaicode\Debugbar\Storage\SocketStorage;
use Omaicode\Debugbar\Storage\FilesystemStorage;
...
use Omaicode\Debugbar\DataCollector\PhpInfoCollector;
use DebugBar\DataCollector\RequestDataCollector;
use DebugBar\DataCollector\TimeDataCollector;
use Omaicode\Debugbar\DataFormatter\QueryFormatter;
use Omaicode\Debugbar\Support\Clockwork\ClockworkCollector;
...
class LaravelDebugbar extends DebugBar
{
    ...
    public function boot()
    {
        ...
        /** @var \Omaicode\Debugbar\LaravelDebugbar $debugbar */
        $debugbar = $this;
        ...
        if (!$this->isLumen() && $this->shouldCollect('route')) {
            try {
                $this->addCollector($this->app->make('Omaicode\Debugbar\DataCollector\RouteCollector'));
            } catch (\Exception $e) {
                $this->addThrowable(
                    new Exception(
        ...
        if ($this->shouldCollect('models', true)) {
            try {
                $modelsCollector = $this->app->make('Omaicode\Debugbar\DataCollector\ModelsCollector');
        ...
        if ($this->shouldCollect('livewire', true) && $this->app->bound('livewire')) {
            try {
                $livewireCollector = $this->app->make('Omaicode\Debugbar\DataCollector\LivewireCollector');
        ...
        if ($this->shouldCollect('gate', false)) {
            try {
                $gateCollector = $this->app->make('Omaicode\Debugbar\DataCollector\GateCollector');
