...
use Omaicode\MediaLibrary\MediaCollections\Exceptions\InvalidConversion;
...
class ConversionCollection extends Collection
{
    ...
    protected function addConversionsFromRelatedModel(Media $media): void
    {
        ...
        /** @var \Omaicode\MediaLibrary\HasMedia $model */
        $model = new $modelName();
    ...
    {
        /** @var \Omaicode\MediaLibrary\Conversions\Conversion|null $conversion */
