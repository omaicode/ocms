...
namespace Omaicode\MediaLibrary\MediaCollections;

use Closure;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Traits\Macroable;
use Omaicode\MediaLibrary\Conversions\ImageGenerators\Image as ImageGenerator;
use Omaicode\MediaLibrary\HasMedia;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\DiskDoesNotExist;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\FileDoesNotExist;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\FileIsTooBig;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\FileUnacceptableForCollection;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\UnknownType;
use Omaicode\MediaLibrary\MediaCollections\File as PendingFile;
use Omaicode\MediaLibrary\MediaCollections\Models\Media;
use Omaicode\MediaLibrary\ResponsiveImages\Jobs\GenerateResponsiveImagesJob;
use Omaicode\MediaLibrary\Support\File;
use Omaicode\MediaLibrary\Support\RemoteFile;
...
class FileAdder
{
    ...
    public function toMediaCollectionFromRemote(string $collectionName = 'default', string $diskName = ''): Media
    {
        ...
        /** @var \Omaicode\MediaLibrary\MediaCollections\Models\Media $media */
