...
use Omaicode\MediaLibrary\Downloaders\DefaultDownloader;
use Omaicode\MediaLibrary\MediaCollections\Events\CollectionHasBeenCleared;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\InvalidBase64Data;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\InvalidUrl;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\MediaCannotBeDeleted;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\MediaCannotBeUpdated;
use Omaicode\MediaLibrary\MediaCollections\Exceptions\MimeTypeNotAllowed;
use Omaicode\MediaLibrary\MediaCollections\FileAdder;
use Omaicode\MediaLibrary\MediaCollections\FileAdderFactory;
...
use Omaicode\MediaLibrary\Support\MediaLibraryPro;
use Omaicode\MediaLibraryPro\PendingMediaLibraryRequestHandler;

trait InteractsWithMedia
{
    /** @var \Omaicode\MediaLibrary\Conversions\Conversion[] */
    public array $mediaConversions = [];

    /** @var \Omaicode\MediaLibrary\MediaCollections\MediaCollection[] */
     ...
     *
     * @return \Omaicode\MediaLibrary\MediaCollections\FileAdder
     */
     ...
     * @return \Omaicode\MediaLibrary\MediaCollections\FileAdder
     *
     * @throws \Omaicode\MediaLibrary\MediaCollections\Exceptions\FileCannotBeAdded
     */
     ...
     *
     * @param string $collectionName
     * @param \Omaicode\MediaLibrary\MediaCollections\Models\Media[]|\Illuminate\Support\Collection $excludedMedia
     *
     * @return $this
     */
     ...
     *
     * @param int|\Omaicode\MediaLibrary\MediaCollections\Models\Media $mediaId
     *
     * @throws \Omaicode\MediaLibrary\MediaCollections\Exceptions\MediaCannotBeDeleted
     */
