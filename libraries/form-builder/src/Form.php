...
use Omaicode\FormBuilder\Fields\BaseField;
use Omaicode\FormBuilder\Fields\Nullable;
use Omaicode\FormBuilder\Layout\Row;
use Omaicode\FormBuilder\Traits\HandleCascadeFields;
use Omaicode\FormBuilder\Traits\HasFields;
use Omaicode\FormBuilder\Traits\HasHooks;
...
class Form implements Renderable
{
    ...
    {
        \request()->session()->flash('toast_success', __('form-builder::messages.created'));
    }
    ...
    {
        \request()->session()->flash('toast_success', __('form-builder::messages.updated'));
    }
