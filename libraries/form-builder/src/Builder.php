...
use Omaicode\FormBuilder\Fields\Hidden;
...
class Builder
{
     ...
     * @var string
     */
    protected $view = 'form-builder::form';
    ...
    public function title(): string
    {
        ...
        if ($this->mode === static::MODE_CREATE) {
            return trans('form-builder::messages.create');
        }

        if ($this->mode === static::MODE_EDIT) {
            return trans('form-builder::messages.edit');
        }
