<?php
namespace Omaicode\FormBuilder\Tools;
...
{    
    ...
    {
        if (empty($this->view)) {
            $this->view = 'form-builder::tools.avatar';
        }        
    }
    ...
    {
        $messages = [
            'invalid_type' => __('form-builder::messages.avatar.invalid_type'),
            'invalid_size' => __('form-builder::messages.avatar.invalid_size'),
        ];
